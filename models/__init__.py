...
from .skip_shared import MultiDecoderSkipNet
import torch.nn as nn

def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3, act_fun='LeakyReLU', skip_n33d=128, skip_n33u=128, skip_n11=4, num_scales=5, downsample_mode='stride', need_sigmoid=True):
    if NET_TYPE == 'ResNet':
        # TODO
    ...
    elif NET_TYPE == 'skip_shared':
        net = MultiDecoderSkipNet(
